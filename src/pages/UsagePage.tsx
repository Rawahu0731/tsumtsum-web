const pageSections = [
  ...
  },
  {
    ...
    summary: 'セッション単位で計測し、プレイごとの CPM と傾向を確認できます。',
    what: [
      'セッションを開始して、プレイごとに時間とコインを記録します。',
      '最新・平均・中央値・最大・最小などの統計を自動で集計します。',
      'Analysis でセッション単位の推移と詳細、Ranking でツム別比較ができます。',
    ],
    how: [
      'Measure でキャラ名・スキル・目標回数・アイテムを設定して Start Session。',
      '1 プレイごとにストップウォッチを止めて、コイン数を入力し Save Play。',
      '目標回数に達したら Finish Session で区切り、Analysis で振り返ります。',
    ],
    tips: [
      'セッション中はコイン入力欄にフォーカスが残るので、片手でも連続入力できます。',
      '時間はストップウォッチの表示（mm:ss）をそのまま保存します。',
      'Ranking の並び替えは中央値が初期値です。目的に応じて切り替えてください。',
    ],
    ranking: {
      title: 'ランキング機能',
      modes: [
        {
          name: 'Sort By (並び替え)',
          description: '記録したプレイをキャラ × スキル × アイテムでまとめ、指標で並び替えます。',
          what: [
            'Median / Average / Max / Min / Play Count を選択可能',
            'Hourly は平均 CPM × 60 で表示',
            'Avg Time と Avg Coins もあわせて確認できる',
          ],
        },
      ],
      understanding: {
        title: '中央値と平均の見方',
        example: `例: Aツム (Median 1200 / Average 1500)
-> 平均は高いが、中央値はやや低め
-> 好調プレイがある一方で、安定感は平均より控えめ`,
        interpretations: [
          'Median は「普段の安定値」、Average は「伸びの上振れ」も含む値です。',
          'Median が高いと安定型、Average だけ高いと波が大きい傾向があります。',
          'Median と Average をセットで見ると、安定感と爆発力の違いが分かります。',
        ],
      },
      tips: [
        '安定感を見たいときは Median、爆発力重視なら Max を使うと判断しやすいです。',
        'Plays が少ないツムは数値がブレやすいので、回数も一緒に確認してください。',
      ],
    },
    calculation: {
      costs: {
